...
import com.example.topgas.Adapter.CartListAdapter;
...
public class Cart extends AppCompatActivity {
    ArrayList<CartModel> arrayList = new ArrayList<CartModel>();
...
//                        Toast.makeText(getApplicationContext(),"nav_home",Toast.LENGTH_SHORT).show();
                        intent = new Intent(Cart.this, CustomerHome.class);
...
//                        Toast.makeText(getApplicationContext(),"nav_setting",Toast.LENGTH_SHORT).show();
                        intent = new Intent(Cart.this, ProfileSetting.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.nav_vehicle:
                        intent = new Intent(Cart.this, ManageVehicle.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.nav_history:
                        intent = new Intent(Cart.this, OrderHistory.class);
                        startActivity(intent);
                        finish();
                    ...
                    case R.id.nav_faq:
                        ...
                        intent = new Intent(Cart.this, FAQ.class);
                        startActivity(intent);
                        finish();
                        break;
                    case R.id.nav_rateus:
                        ...
                        break;
                    case R.id.nav_help:
                        intent = new Intent(Cart.this, HowTo.class);
                        startActivity(intent);
                        finish();
                        break;
...
//                        Toast.makeText(getApplicationContext(),"nav_logout",Toast.LENGTH_SHORT).show();
        ...
        cartListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                intent = new Intent(Cart.this, OrderDetail.class);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if(status.equals("true")){
                                ...
                                cartListAdapter = new CartListAdapter(Cart.this, arrayList);
